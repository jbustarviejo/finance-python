...
class DbInsert:
    ...
    def saveOptSVC_old(self, companyId, max, min):
    ...
    def saveOptSVMResult(self, companyId, svm, kernel, rate, proba, prof_perc, prof_perc_with_alg, prof_perc_with_ems, rate_ems, number_of_ones, numberOfDaysSample, numberOfTrainVectors, prof_perc_better, prof_perc_worst, year):
        ...
        query = "INSERT INTO companiesSVM (company_id, svm, kernel, rate, proba, number_of_ones, number_of_days_sample, number_of_train_vectors, profitability_percentage, profitability_percentage_with_alg, profitability_percentage_with_ems, rate_ems, prof_perc_better, prof_perc_worst, year, created_at, updated_at) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s', NOW(), NOW()) ON DUPLICATE KEY UPDATE company_id='%s', svm='%s', kernel='%s', rate='%s', proba='%s', number_of_ones='%s', number_of_days_sample='%s', number_of_train_vectors='%s', profitability_percentage='%s', profitability_percentage_with_alg ='%s', profitability_percentage_with_ems ='%s', rate_ems='%s', prof_perc_better='%s', prof_perc_worst='%s', year='%s'" % (companyId, svm, kernel, rate, proba, number_of_ones, numberOfDaysSample, numberOfTrainVectors, prof_perc, prof_perc_with_alg, prof_perc_with_ems, rate_ems, prof_perc_better, prof_perc_worst, year, companyId, svm, kernel, rate, proba, number_of_ones, numberOfDaysSample, numberOfTrainVectors, prof_perc, prof_perc_with_alg, prof_perc_with_ems, rate_ems, prof_perc_better, prof_perc_worst, year)
        # print(query)
        Database().runQuery(query)
